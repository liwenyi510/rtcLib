...
#include <Arduino.h>
// 定义PCF8563闹钟相关的宏
#define PCF8563_ALARM_MIN_ADDR 0x09
#define PCF8563_ALARM_HR_ADDR  0x0A
#define PCF8563_ALARM_DAY_ADDR 0x0B
#define PCF8563_ALARM_WEEKDAY_ADDR 0x0C
#define PCF8563_ALARM_AIE      0x02
#define PCF8563_ALARM_AF       0x08
#define PCF8563_NO_ALARM       99
// 在 rtclib.h 文件中添加以下代码
...
public:
  ...
  void writeSqwPinMode(Pcf8563SqwPinMode mode);
      ...
      boolean alarmActive();
      void getAlarm(byte &min, byte &hour, byte &day, byte &weekday);
              // 添加缺失的函数声明
